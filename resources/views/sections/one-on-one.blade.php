                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
                    <div class="bg-gray-50 rounded-lg p-6">
                        <div class="flex items-center mb-4">
                            <img src="{{ asset('images/tawananyasha.jpg') }}" alt="Tawananyasha Ziyambe" class="w-16 h-16 rounded-full object-cover" />
                            <div class="ml-4">
                                <h4 class="text-lg font-semibold">Tawananyasha Ziyambe</h4>
                                <p class="text-sm text-gray-500">Chief Technological Officer</p>
                            </div>
                        </div>
                        <p class="text-sm text-gray-600 mb-4">Experienced technology leader with expertise in fintech solutions, blockchain, and enterprise architecture. Drives innovation and digital transformation while ensuring robust, scalable systems.</p>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6">
                        <div class="flex items-center mb-4">
                            <img src="{{ asset('images/tanatswa.jpg') }}" alt="Tanatswa Nguruza" class="w-16 h-16 rounded-full object-cover" />
                            <div class="ml-4">
                                <h4 class="text-lg font-semibold">Tanatswa Nguruza</h4>
                                <p class="text-sm text-gray-500">Customer Support Manager</p>
                            </div>
                        </div>
                        <p class="text-sm text-gray-600 mb-4">Dedicated customer support professional focused on providing excellent service and building strong client relationships. Growing expertise in financial services support and team leadership.</p>
                        <div class="flex items-center text-sm text-gray-500">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6">
                        <div class="flex items-center mb-4">
                            <img src="{{ asset('images/anashe.jpg') }}" alt="Anashe Masomeke" class="w-16 h-16 rounded-full object-cover" />
                            <div class="ml-4">
                                <h4 class="text-lg font-semibold">Anashe Masomeke</h4>
                                <p class="text-sm text-gray-500">Chief Marketing Officer</p>
                            </div>
                        </div>
                        <p class="text-sm text-gray-600 mb-4">Rising marketing professional with fresh perspectives on digital marketing and brand development. Bringing energy and creativity to build our market presence while gaining valuable leadership experience.</p>
                        <div class="flex items-center text-sm text-gray-500">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
